...
export async function deleteErrorDetail(
  ...
  try {
    ...
    console.error("Error deleting quote check error detail:", error);
    throw error;
  }
}
...
export async function undoDeleteErrorDetail(
  ...
  try {
    ...
    console.error("Error undoing delete quote check error detail:", error);
    throw error;
  }
}
...
> {
  try {
    ...
    console.error(
      "Error fetching quote check delete error detail reasons:",
      error
    );
    throw error;
  }
...
export async function updateErrorDetail(
  ...
  try {
    ...
    console.error("Error updating quote check error detail:", error);
    throw error;
  }
}
